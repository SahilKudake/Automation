package com.selenium.irctc.automation;
...
/**
 * Purpose : Program to automate the registration page of IRCTC website
 * 
 * @author Sahil Kudake
 *
 */
public class Irctc extends Base {
	...
	public static void registerIrctc() throws InterruptedException {
		// thread.sleep is added to check the proper working of components of the web page
